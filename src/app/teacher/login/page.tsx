    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-yellow-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Teacher Sign In</h2>
          <p className="text-gray-600">Access your Karavan account</p>
        </div>
      </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <Link href="/teacher/forgot-password" className="font-medium text-emerald-600 hover:text-emerald-500">
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-gray-500">New to Karavan?</span>
              </div>
            </div>
